    ...
    return (
        <div className="flex-shrink-0 w-full h-16 bg-white py-2 px-1 md:p-4">
            <form className="w-full h-full md:flex items-center justify-center">
                ...
                <button type='submit' onClick={sendMessage} className="py-2 px-4 md:px-6 md:flex-shrink-0 rounded-md bg-[#4169fc] font-medium text-white hover:cursor-pointer">Send</button>
            </form>
        </div>
    )
}
